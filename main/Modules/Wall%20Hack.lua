--[[
	...
	Wall Hack Module [SmartHub] by spiffy © CC0 1.0 Universal (2023)
...
if not getgenv().SmartHub or getgenv().SmartHub.WallHack then return end
...
local Environment = getgenv().SmartHub.WallHack
...
function Environment.Functions:Exit()
	...
	getgenv().SmartHub.WallHack.Functions = nil
	getgenv().SmartHub.WallHack = nil
